// Demo personas only — this cookie is just a client-set "which view am I
// previewing" preference, not a real session. It's what lets
// gated routes (e.g. /me/scheduling, /me/uploads) tell instructor-view from student-view.
